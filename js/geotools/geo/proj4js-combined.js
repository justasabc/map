...
Proj4js.defs = {
  ...
  'CUSTOM:FOSHAN113': "+proj=tmerc +lat_0=-0.000389 +lon_0=113.000750 +k=1 +x_0=500000 +y_0=0 +a=6378140 +b=6356755.288157528 +units=m +no_defs"
};
...
Proj4js.defs["EPSG:WGS84_1"] = "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs";
Proj4js.defs["EPSG:XIAN80_1"] = "+proj=tmerc +a=6378140.000000000000000000 +b=6356755.288157528300 +lat_0=0 +lon_0=120.0 +x_0=500000 +y_0=0 +k=1.0 +units=m +no_defs";
var sourceProj = new Proj4js.Proj("EPSG:WGS84_1");
var destProj = new Proj4js.Proj("EPSG:XIAN80_1");
