...
// global variables
// notice varialbes g_xxx will be used in xxx.js files
var level = 19;
var map;
var city = "佛山市";
var map_id = "allmap";
...
function init_map(){
	map = new BMap.Map(map_id,{enableMapClick:false}); 
...
function register_ui_events_dom(){
	...
	// upload file
	//========================================================================
	registerFileEvent(file_id); // register	
}
