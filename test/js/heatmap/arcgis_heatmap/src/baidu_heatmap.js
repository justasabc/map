...
/*==============================以下部分为heatmap.js的核心代�?,只负责热力图的展�?, 代码来自第三�?====================================*/
 ...
 * 主入口类�?<a href="symbols/BMapLib.Heatmap.html">Heatmap</a>�?
 * 基于Baidu Map API 2.0�?
 *
...
(function() {
     ...
     * <br />"<b>visible</b>" : {Number} 热力图是否显�?,
     * <br />"<b>gradient</b>" : {JSON} 热力图的渐变区间,
     * <br />"<b>opacity</b>" : {Number} 势力的透明�?,
     *
     * @example <b>参考示例：</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var heatmapOverlay = new BMapLib.HeatmapOverlay({"radius":10, "visible":true, "opacity":70});<br />heatmapOverlay.setDataSet(data);//data是热力图的详细数�?
     */
    ...
    BMapLib.HeatmapOverlay = HeatmapOverlay; // 向命名空间注�?.
})()